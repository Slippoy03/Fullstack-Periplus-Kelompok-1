...
const Navbar = ({ jumbotron }) => {
  ...
  return (
    <nav>
      ...
      >
        <div className="bg-purple-600 shadow-md xl:h-20 min-h-full xl:px-[15%] md:px-10 px-5 py-3 flex flex-col xl:flex-row justify-around xl:items-center gap-x-0 gap-y-2 xl:gap-x-2">
